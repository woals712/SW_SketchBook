<template>
  <div id="app" class="container" v-if="tempname || wantuser">
    <p class="plusB btn btn-danger" v-if="!tempname && wantuser">{{ wantuser }} 아이디 열람 모드</p>
    <div class="title" style="padding-bottom:30px;padding-top:20px;text-align:center;">
      <img src="../assets/img/titlegithub.png">
    </div>

    <Search :is-loading="isLoading" @formSubmit="loadUser"/>
    <div v-if="notFound" class="notFound">
      <FontAwesomeIcon :icon="frown" size="10x" />
      <p>하루 요청 회수를 초과하였습니다 (분당 10회)</p>
    </div>
